...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='samplebot_description').find('samplebot_description')
    default_model_path = os.path.join(pkg_share, 'urdf/samplebot.xacro')
    ...
    arguments=['-entity', 'samplebot', '-topic', 'robot_description'],
    parameters= [{'use_sim_time': use_sim_time}],
    output='screen'
    )
